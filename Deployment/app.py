...
model = tf.keras.models.load_model(r"C:\Users\Asus\Downloads\oneDNN.h5")
...
# Streamlit app
def app():
    st.title("PPE Detection For Industrial Workers")
    image = Image.open(r"C:\Users\Asus\Downloads\detection.jpg")
